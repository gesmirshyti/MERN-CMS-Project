...
export default function Home() {
  return (
    <div>
        ...
        <div className="container d-flex">
          <div className="middle">
            <h1 className="text-white display-3 fw-bold">
             Connect your <span className="theme-text">Business </span>to the world.
            </h1>
          </div>
        </div>
        <img
      ...
      <div class="container-home-cards"><br />
        <p class="container-home-title">We are proud to present :</p>
      
        <div class="gradient-cards">
          <div class="card-home">
            <div class="container-card-home bg-green-box">
              ...
              <p class="card-description">Costs zero Dollars to start up your Business with us. You just Need a Product to sell.</p>
            </div>
          </div>
      
          <div class="card-home">
            <div class="container-card-home bg-white-box">
              <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p class="card-title">Multi-Payment</p>
              <p class="card-description">Soon to be updated with Multiple ways to pay(Paypal,Stripe,MasterCard,Visa, Crypto)etc...</p>
            </div>
          </div>
      
          <div class="card-home">
            <div class="container-card-home bg-yellow-box">
              <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p class="card-title">Help your Business Grow</p>
              <p class="card-description">You Can help your Business Grow By showing your products to the whole world.</p>
            </div>
          </div>
      
          <div class="card-home">
            <div class="container-card-home  bg-blue-box">
              <svg width="80" height="80" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p class="card-title">Grow your business up to 11x </p>
              <p class="card-description">CMS Goal is to make the connection of business and customer easier.</p>
            </div>
          </div>
        </div>
      </div>
